...
class Optimiser:
    ...
    def __init__(
        ...
        self.full_construct = True                 # a flag to construct functions with caches to rebuild the cache
    ...
    def construct(self):
        ...
        for optimiser in self.get_all_suboptimisers():
            if optimiser.has_changed() or self.full_construct:
                optimiser_full_construct_original = optimiser.full_construct
                optimiser.full_construct = self.full_construct
                if self.verbose:
                ...
                optimiser.full_construct = optimiser_full_construct_original
    ...
    def optimise(
        ...
        self.full_construct = True 
        self.construct()
        self.full_construct = False
