...
def optimise_method(
    ...
    def actual_decorator(function):
        ...
        def new_function(self,*args,**kwargs):
            ...
            if self.construct_on_add and execute_now:
...
class Optimiser:
    ...
    def __init__(
        ...
        self.construct_on_add = True              # if False then suppress automatic execution of construct functions in methods decorated by optimise_method
