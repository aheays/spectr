...
class Optimiser:
    ...
    def __init__(
        ...
        self._first_construct = True                 # means construct method has not yet been called, and only post_construct_functions will be run (assumes all construct functions run by add_construct_function)
    ...
    def construct(self,clean=False):
        ...
        for o in self.get_all_suboptimisers():
            ...
            if (
                ...
                ## collect all construct functions. If first construct
                ## run ony post_construct_functions, which assumes
                ## normal construct_functions were run by
                ## add_construct_function. Save the residual and mark
                ## the construct time
                o.residual = []
                if o._first_construct:
