...
tests = [
    ...
    # ##     # temperature=487,
    # ##     # J=np.arange(0,76),
    # ##     # lower_levels=({'name':'B.3Πg(v=1)','Tv':11255.202248,'Bv':1.61055197,'Dv':5.89799e-06,'Hv':-3.94391e-13,'Av':42.1932,'AD':-0.000421635,'λv':-0.203999,'λDv':-6.34857e-07,'γv':-0.00367735,'ov':1.15017,'p':0.00431673,'q':8.34856e-05,},),
    # ##     # upper_levels=({'name':'W.3Δu(v=3)','Tv':13989.734287,'Bv':1.41063813,'Dv':5.65923e-06,'Hv':-6.54037e-13,'Av':5.6636,'AD':3.92926e-06,'λv':0.67833,'λDv':1.51497e-06,'γv':-0.00288008,},),
