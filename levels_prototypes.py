...
# def _f1(self,classname,J,Inuclear,sa):
    ...
    # else:
        ...
        # else:
            # return (2*J+1)*neven
# prototypes['g'] = dict(description="Level degeneracy including nuclear spin statistics" , kind='i' , infer={('classname','J'):_f0, ('classname','J','Inuclear','sa'):_f1,})
