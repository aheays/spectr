...
## upper state, A.1Π included to provided allowed transition strength to ap.3Σ+(5).  
...
upper.add_level(name='ap.3Σ+(v=5)',
    ## optimise molecular constants of a'(5)
    Tv=P(61981.6505242+0.1, True,0.001,0.003),
    Bv=P(1.13803172462, True,1e-05,9e-06),
    Dv=P(4.00075877615e-06, True,1e-8,1.3e-07),
...
#     ## optimise temperature and column density
#     Teq=P(235.791023479, True,1,2.3),
#     Nself=P(1.43053973766e+20, True,1e+17,1e+18),)

## optimise temperature and column density
transition.line.set_parameter('Teq',P(235.791023479,False,1,2.3))
transition.line.set_parameter('Nself',P(1.43053973766e+20,False,1e+17,1e+18))
...
model.optimise()
# model.save_to_directory('04_fit_13C18O_ap-X_5-0_band_model.output')

## output optimised parameters in this file
