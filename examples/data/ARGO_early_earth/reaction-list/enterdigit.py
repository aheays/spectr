...
for line in fin:
	...
	if newtype == 'A' or newtype == 'D' or newtype == 'F' or newtype == 'V' or newtype == 'Z' or newtype == 'L' or newtype == 'U' or newtype == 'GL' or newtype == 'EV' or newtype == 'DP' or newtype == 'BA' or newtype == 'GO' or newtype == 'TR' or newtype == 'RA' or newtype == 'AI' or newtype == 'AS':
		i += 1
